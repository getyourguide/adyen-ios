...
open class FormTextItem: FormValueItem<String, FormTextItemStyle>, ValidatableFormItem, InputViewRequiringFormItem {
    ...
    @Adyen.Observable(nil) public var placeholder: String?
    ...
    @Adyen.Observable(nil) public var validationFailureMessage: String?
    ...
    @Adyen.Observable("") internal var formattedValue: String
